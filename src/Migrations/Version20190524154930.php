 ...
 */
class Version20190524154930 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE address_book (id INTEGER NOT NULL, firstname VARCHAR(40) NOT NULL COLLATE BINARY, lastname VARCHAR(40) NOT NULL COLLATE BINARY, street VARCHAR(40) NOT NULL COLLATE BINARY, streetnumber VARCHAR(10) NOT NULL COLLATE BINARY, zip INTEGER NOT NULL, city VARCHAR(50) NOT NULL COLLATE BINARY, country VARCHAR(40) NOT NULL COLLATE BINARY, phonenumber VARCHAR(15) NOT NULL COLLATE BINARY, email VARCHAR(100) NOT NULL COLLATE BINARY, picture VARCHAR(25) DEFAULT NULL COLLATE BINARY, birthday VARCHAR(8) NOT NULL, PRIMARY KEY(id))');
